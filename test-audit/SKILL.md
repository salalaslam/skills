...
Originally from [OpenClaw](https://github.com/openclaw/openclaw).

Source: [test-audit skill](https://github.com/openclaw/openclaw/blob/57a305156cad62872ee1975115b190107972e412/.agents/skills/test-audit/SKILL.md).
The upstream instructions and campaign guide are unchanged; this attribution section was added locally.
Distributed under the [MIT License](LICENSE). Copyright (c) 2026 OpenClaw Foundation.
